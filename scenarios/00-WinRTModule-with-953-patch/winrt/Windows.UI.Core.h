...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::VisualTreeIsland) consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>::CompositionIsland() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindow_CompositionIslands)->get_CompositionIsland(&value));
        return winrt::Windows::UI::Composition::VisualTreeIsland{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::CompositionIslandEnvironment) consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>::CompositionIslandEnvironment() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindow_CompositionIslands)->get_CompositionIslandEnvironment(&value));
        return winrt::Windows::UI::Composition::CompositionIslandEnvironment{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::VisualTreeIsland) consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>::ConfigureCompositionIsland(winrt::Windows::UI::Composition::Compositor const& compositor) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindow_CompositionIslands)->ConfigureCompositionIsland(*(void**)(&compositor), &result));
        return winrt::Windows::UI::Composition::VisualTreeIsland{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>::DestroyCompositionIsland() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindow_CompositionIslands)->DestroyCompositionIsland());
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::UI::Core::CoreWindow) consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>::GetForOwningThread() const
    {
        void* ppWindow{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::UI::Core::ICoreWindow_CompositionIslands)->GetForOwningThread(&ppWindow));
        return winrt::Windows::UI::Core::CoreWindow{ ppWindow, take_ownership_from_abi };
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::UI::Core::ICoreWindow_CompositionIslands> : produce_base<D, winrt::Windows::UI::Core::ICoreWindow_CompositionIslands>
    {
        int32_t __stdcall get_CompositionIsland(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::UI::Composition::VisualTreeIsland>(this->shim().CompositionIsland());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_CompositionIslandEnvironment(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::UI::Composition::CompositionIslandEnvironment>(this->shim().CompositionIslandEnvironment());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall ConfigureCompositionIsland(void* compositor, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
            *result = detach_from<winrt::Windows::UI::Composition::VisualTreeIsland>(this->shim().ConfigureCompositionIsland(*reinterpret_cast<winrt::Windows::UI::Composition::Compositor const*>(&compositor)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall DestroyCompositionIsland() noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            this->shim().DestroyCompositionIsland();
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall GetForOwningThread(void** ppWindow) noexcept final try
        {
            clear_abi(ppWindow);
            typename D::abi_guard guard(this->shim());
            *ppWindow = detach_from<winrt::Windows::UI::Core::CoreWindow>(this->shim().GetForOwningThread());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace std
{
    ...
    template<> struct hash<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands> : winrt::impl::hash_base {};
