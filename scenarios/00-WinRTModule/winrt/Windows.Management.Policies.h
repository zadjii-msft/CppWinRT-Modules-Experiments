...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->get_AccountId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::System::User) consume_Windows_Management_Policies_INamedPolicySetter<D>::User() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->get_User(&value));
        return winrt::Windows::System::User{ value, take_ownership_from_abi };
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->SetBooleanPolicyAtPath(*(void**)(&area), *(void**)(&name), policyValue));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->SetInt32PolicyAtPath(*(void**)(&area), *(void**)(&name), policyValue));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->SetInt64PolicyAtPath(*(void**)(&area), *(void**)(&name), policyValue));
    }
    ...
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->SetStringPolicyAtPath(*(void**)(&area), *(void**)(&name), *(void**)(&policyValue)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Management_Policies_INamedPolicySetter<D>::SetBinaryPolicyAtPath(param::hstring const& area, param::hstring const& name, winrt::Windows::Storage::Streams::IBuffer const& policyValue) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicySetter)->SetBinaryPolicyAtPath(*(void**)(&area), *(void**)(&name), *(void**)(&policyValue)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Management::Policies::NamedPolicySetter) consume_Windows_Management_Policies_INamedPolicyStatics2<D>::TryCreatePolicySetter(param::hstring const& accountId) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicyStatics2)->TryCreatePolicySetter(*(void**)(&accountId), &result));
        return winrt::Windows::Management::Policies::NamedPolicySetter{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Management::Policies::NamedPolicySetter) consume_Windows_Management_Policies_INamedPolicyStatics2<D>::TryCreatePolicySetterForUser(winrt::Windows::System::User const& user, param::hstring const& accountId) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicyStatics2)->TryCreatePolicySetterForUser(*(void**)(&user), *(void**)(&accountId), &result));
        return winrt::Windows::Management::Policies::NamedPolicySetter{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) consume_Windows_Management_Policies_INamedPolicyStatics2<D>::ClearAllPoliciesAsync(param::hstring const& accountId) const
    {
        void* asyncAction{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicyStatics2)->ClearAllPoliciesForAccountAsync(*(void**)(&accountId), &asyncAction));
        return winrt::Windows::Foundation::IAsyncAction{ asyncAction, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) consume_Windows_Management_Policies_INamedPolicyStatics2<D>::ClearAllPoliciesAsync() const
    {
        void* asyncAction{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Management::Policies::INamedPolicyStatics2)->ClearAllPoliciesAsync(&asyncAction));
        return winrt::Windows::Foundation::IAsyncAction{ asyncAction, take_ownership_from_abi };
    }
