...
WINRT_EXPORT namespace winrt::Windows::UI::Core
{
    ...
    struct __declspec(empty_bases) CoreWindow : winrt::Windows::UI::Core::ICoreWindow,
        impl::require<CoreWindow, winrt::Windows::UI::Core::ICoreWindow2, winrt::Windows::UI::Core::ICorePointerRedirector, winrt::Windows::UI::Core::ICoreWindow3, winrt::Windows::UI::Core::ICoreWindow4, winrt::Windows::UI::Core::ICoreWindow5, winrt::Windows::UI::Core::ICoreWindow_CompositionIslands, winrt::Windows::UI::Core::ICoreWindowWithContext>
    {
