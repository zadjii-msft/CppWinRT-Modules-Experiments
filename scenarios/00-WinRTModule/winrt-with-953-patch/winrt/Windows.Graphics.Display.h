...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::Display::LogicalDisplayReference>) consume_Windows_Graphics_Display_ILogicalDisplayReferenceStatics<D>::FindAll() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Graphics::Display::ILogicalDisplayReferenceStatics)->FindAll(&result));
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::Display::LogicalDisplayReference>) consume_Windows_Graphics_Display_ILogicalDisplayReferenceStatics<D>::FindAll(winrt::Windows::UI::WindowManagement::WindowingEnvironment const& environment) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Graphics::Display::ILogicalDisplayReferenceStatics)->FindAllForWindowingEnvironment(*(void**)(&environment), &result));
        return winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::Display::LogicalDisplayReference>{ result, take_ownership_from_abi };
    }
