...
WINRT_EXPORT namespace winrt::Windows::UI::Core
{
    ...
    struct __declspec(empty_bases) ICoreWindow_CompositionIslands :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<ICoreWindow_CompositionIslands>
    {
        ICoreWindow_CompositionIslands(std::nullptr_t = nullptr) noexcept {}
        ICoreWindow_CompositionIslands(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
        ICoreWindow_CompositionIslands(ICoreWindow_CompositionIslands const&) noexcept = default;
        ICoreWindow_CompositionIslands(ICoreWindow_CompositionIslands&&) noexcept = default;
        ICoreWindow_CompositionIslands& operator=(ICoreWindow_CompositionIslands const&) & noexcept = default;
        ICoreWindow_CompositionIslands& operator=(ICoreWindow_CompositionIslands&&) & noexcept = default;
    };
