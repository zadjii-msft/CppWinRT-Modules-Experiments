...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::Display::LogicalDisplayReference>) FindAll() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::Display::LogicalDisplayReference>) FindAll(winrt::Windows::UI::WindowManagement::WindowingEnvironment const& environment) const;
    };
