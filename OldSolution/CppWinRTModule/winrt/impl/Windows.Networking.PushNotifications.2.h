...
WINRT_EXPORT namespace winrt::Windows::Networking::PushNotifications
{
    ...
    struct __declspec(empty_bases) PushNotificationChannelManagerForUser : winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser,
        impl::require<PushNotificationChannelManagerForUser, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser2, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3>
    {
    ...
    struct __declspec(empty_bases) PushNotificationChannelResult : winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult
    {
        PushNotificationChannelResult(std::nullptr_t) noexcept {}
        PushNotificationChannelResult(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult(ptr, take_ownership_from_abi) {}
        PushNotificationChannelResult(PushNotificationChannelResult const&) noexcept = default;
        PushNotificationChannelResult(PushNotificationChannelResult&&) noexcept = default;
        PushNotificationChannelResult& operator=(PushNotificationChannelResult const&) & noexcept = default;
        PushNotificationChannelResult& operator=(PushNotificationChannelResult&&) & noexcept = default;
    };
