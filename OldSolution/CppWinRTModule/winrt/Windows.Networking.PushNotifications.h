...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>) consume_Windows_Networking_PushNotifications_IPushNotificationChannelManagerForUser3<D>::CreateChannelAsync(param::hstring const& remoteId) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3)->CreateChannelAsync(*(void**)(&remoteId), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>) consume_Windows_Networking_PushNotifications_IPushNotificationChannelManagerForUser3<D>::CreateChannelWithAppIdAsync(param::hstring const& remoteId, param::hstring const& AppId) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3)->CreateChannelWithAppIdAsync(*(void**)(&remoteId), *(void**)(&AppId), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>{ operation, take_ownership_from_abi };
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Networking::PushNotifications::PushNotificationChannel) consume_Windows_Networking_PushNotifications_IPushNotificationChannelResult<D>::Channel() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult)->get_Channel(&value));
        return winrt::Windows::Networking::PushNotifications::PushNotificationChannel{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::hresult) consume_Windows_Networking_PushNotifications_IPushNotificationChannelResult<D>::ExtendedError() const
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3> : produce_base<D, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3>
    {
        int32_t __stdcall CreateChannelAsync(void* remoteId, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>>(this->shim().CreateChannelAsync(*reinterpret_cast<hstring const*>(&remoteId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall CreateChannelWithAppIdAsync(void* remoteId, void* AppId, void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult>>(this->shim().CreateChannelWithAppIdAsync(*reinterpret_cast<hstring const*>(&remoteId), *reinterpret_cast<hstring const*>(&AppId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult> : produce_base<D, winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult>
    {
        int32_t __stdcall get_Channel(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::Networking::PushNotifications::PushNotificationChannel>(this->shim().Channel());
            return 0;
        }
        catch (...) { return to_hresult(); }
...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::Networking::PushNotifications::IPushNotificationChannelManagerForUser3> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Windows::Networking::PushNotifications::IPushNotificationChannelResult> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Windows::Networking::PushNotifications::PushNotificationChannelResult> : winrt::impl::hash_base {};
