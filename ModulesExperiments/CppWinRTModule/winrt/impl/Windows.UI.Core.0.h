...
WINRT_EXPORT namespace winrt::Windows::UI::Core
{
    ...
    struct ICoreWindow_CompositionIslands;
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands>{ using type = interface_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands> = L"Windows.UI.Core.ICoreWindow_CompositionIslands";
    ...
    template <> inline constexpr guid guid_v<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands>{ 0xA7FF5B48,0x94E0,0x40E6,{ 0x8A,0x80,0x22,0x84,0x82,0xB6,0x88,0xBA } }; // A7FF5B48-94E0-40E6-8A80-228482B688BA
    ...
    template <> struct abi<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands>
    {
        struct __declspec(novtable) type : inspectable_abi
        {
            virtual int32_t __stdcall get_CompositionIsland(void**) noexcept = 0;
            virtual int32_t __stdcall get_CompositionIslandEnvironment(void**) noexcept = 0;
            virtual int32_t __stdcall ConfigureCompositionIsland(void*, void**) noexcept = 0;
            virtual int32_t __stdcall DestroyCompositionIsland() noexcept = 0;
            virtual int32_t __stdcall GetForOwningThread(void**) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Windows_UI_Core_ICoreWindow_CompositionIslands
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::VisualTreeIsland) CompositionIsland() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::CompositionIslandEnvironment) CompositionIslandEnvironment() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Composition::VisualTreeIsland) ConfigureCompositionIsland(winrt::Windows::UI::Composition::Compositor const& compositor) const;
        WINRT_IMPL_AUTO(void) DestroyCompositionIsland() const;
        WINRT_IMPL_AUTO(winrt::Windows::UI::Core::CoreWindow) GetForOwningThread() const;
    };
    template <> struct consume<winrt::Windows::UI::Core::ICoreWindow_CompositionIslands>
    {
        template <typename D> using type = consume_Windows_UI_Core_ICoreWindow_CompositionIslands<D>;
    };
    template <typename D>
